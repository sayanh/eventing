...
import (
	...
	messagingv1alpha1 "knative.dev/eventing/contrib/kafka/pkg/apis/messaging/v1alpha1"
	versioned "knative.dev/eventing/contrib/kafka/pkg/client/clientset/versioned"
	internalinterfaces "knative.dev/eventing/contrib/kafka/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "knative.dev/eventing/contrib/kafka/pkg/client/listers/messaging/v1alpha1"
)
